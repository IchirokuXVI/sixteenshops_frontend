    ...
    template: `
        <div *ngIf="visible" [ngClass]="'p-confirm-popup p-component'" [ngStyle]="style" [class]="styleClass" (click)="onOverlayClick($event)"
            ...
            <div class="p-confirm-popup-footer">
                <button type="button" pButton [icon]="confirmation?.rejectIcon!" [label]="rejectButtonLabel" (click)="reject()" [class.p-order-2]="reverse" [ngClass]="'p-confirm-popup-reject p-button-sm'"
...
export class ConfirmPopup implements OnDestroy {
    ...
    getElementToFocus() {
        switch(this.confirmation?.defaultFocus) {
            case 'accept':
